...
```r
# Install the PheWAS dependency first
# (see https://github.com/PheWAS/PheWAS for instructions)

# Install ExtendedPheWAS from local source
install.packages("path/to/ExtendedPheWAS", repos = NULL, type = "source")
```

### Dependencies

- **Required:** R (>= 4.0.0), PheWAS
- **Imports:** dplyr, tidyr, ggplot2 (>= 3.0.0), stringr, stringdist, rlang, MASS
