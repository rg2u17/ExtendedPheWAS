...
test_that("chapter_to_phecode_base maps correctly", {
  expect_equal(unname(chapter_to_phecode_base("A")), 1000L)
  expect_equal(unname(chapter_to_phecode_base("M")), 2100L)
  expect_equal(unname(chapter_to_phecode_base("K")), 1900L)
